...
Route::get('payments/stripe/return', 'StripeController@handleStripeReturn')->name('payments.stripe.return');
...
Route::middleware('auth')->group(function () {
    ...
    //Route::get('eProviderPayouts/edit/{id}', 'EProviderPayoutController@edit')->name('eProviderPayouts.edit');
    Route::resource('eProviderPayouts', 'EProviderPayoutController');
