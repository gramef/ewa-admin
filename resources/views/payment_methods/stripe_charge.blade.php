    ...
    <main>
        <section class="container-lg">
            ...
            <div class="cell example example1" id="example-1">
                <div>
                    <img src="https://ewaofficialapp.com/storage/app/public/15/EWA-logo-2.png" alt="EWA" width="120" height="80">
                </div>
                <form>
                    <fieldset>
                        <div class="row">
...
<script type="application/javascript">
    ...
    function handleServerResponse(response) {
        if (response.error) {
            // Show error from server on payment page
            enableInputs();
    ...
    function registerElements(elements, exampleName) {
        ...
        form.addEventListener('submit', function(e) {
            ...
            var additionalData = {
                ...
                address_line1: form.querySelector('#' + exampleName + '-address')?.value,
                address_city: form.querySelector('#' + exampleName + '-city')?.value,
                address_state: form.querySelector('#' + exampleName + '-state')?.value,
                address_zip: form.querySelector('#' + exampleName + '-zip')?.value,
            };
