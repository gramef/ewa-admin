...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            ...
            <a href="#loadMediaModal" data-dropzone="logo" data-toggle="modal" data-target="#mediaModal"
...
<div class="col-12 custom-field-container">
    @if(isset($paymentMethod))
        ...
        @elseif($paymentMethod['route'] == "/ApplePay")
            @include('payment_methods.applepay')
...
<div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
    ...
    <a href="{!! route('paymentMethods.index') !!}" class="btn btn-default"><i
