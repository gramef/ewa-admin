    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                <div class="small-box" style="border-left: 3px solid var(--ewa-accent, #c8956c) !important;">
                    <div class="inner">
                        <h3>{{$bookingsCount}}</h3>
                        <p>{{trans('lang.dashboard_total_bookings')}}</p>
                    </div>
                    <div class="icon"><i class="fas fa-calendar-check"></i></div>
                    <a href="{{route('bookings.index')}}" class="small-box-footer">{{trans('lang.dashboard_more_info')}} <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-6">
                <div class="small-box" style="border-left: 3px solid var(--ewa-success, #4ade80) !important;">
                    <div class="inner">
                    ...
                    <a href="{{route('earnings.index')}}" class="small-box-footer">{{trans('lang.dashboard_more_info')}} <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-6">
                <div class="small-box" style="border-left: 3px solid var(--ewa-info, #60a5fa) !important;">
                    <div class="inner">
                        <h3>{{$eProvidersCount}}</h3>
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box" style="border-left: 3px solid var(--ewa-warning, #fbbf24) !important;">
                    <div class="inner">
                        <h3>{{$membersCount}}</h3>
                        <p>{{trans('lang.dashboard_total_customers')}}</p>
                    </div>
                    <div class="icon"><i class="fas fa-users"></i></div>
                    <a href="{!! route('users.index') !!}" class="small-box-footer">{{trans('lang.dashboard_more_info')}} <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-row justify-content-end">
                            <span class="mr-2"> <i class="fas fa-square" style="color: var(--ewa-accent, #c8956c)"></i>
                ...
                <div class="card">
                    <div class="card-header no-border">
                        ...
                        <div class="card-tools">
                            <a href="{{route('eProviders.index')}}" class="btn btn-tool btn-sm"><i class="fas fa-bars"></i>
                            </a>
                        </div>
                    </div>
...
@push('scripts')
    <script type="text/javascript">
        ...
        function renderChart(chartNode, data, labels) {
            var ticksStyle = {
                fontColor: 'rgba(240, 236, 228, 0.6)',
                fontStyle: 'bold'
            };
            ...
            return new Chart(chartNode, {
                ...
                options: {
                    ...
                    tooltips: {
                        ...
                        titleFontColor: '#f0ece4',
                        bodyFontColor: 'rgba(240, 236, 228, 0.8)',
