            ...
            <div class="row mb-2">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb bg-white float-sm-right rounded-pill px-4 py-2 d-none d-md-flex">
                        ...
                        <li class="breadcrumb-item active">{{trans('lang.e_provider_payout_edit')}}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    ...
                    @endcan
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}"><i class="fas fa-plus mr-2"></i>{{trans('lang.e_provider_payout_edit')}}
                        </a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                {!! Form::model($eProviderPayout, ['route' => ['eProviderPayouts.update', $eProviderPayout->id], 'method' => 'patch', 'files' => true]) !!}
                <div class="row">
