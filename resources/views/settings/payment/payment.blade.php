    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <h5 class="col-12 pb-4 pt-3 border-top"><i class="mr-3 fas fa-university"></i>Vendor Payout Configuration</h5>
                <!-- vendor_payout_mode Field -->
                <div class="form-group row col-12">
                    {!! Form::label('vendor_payout_mode', 'Vendor Payout Mode', ['class' => 'col-3 control-label text-right font-weight-bold']) !!}
                    <div class="col-9">
                        {!! Form::select('vendor_payout_mode', [
                            'stripe_connect' => 'Stripe Connect (Automated payouts to vendor bank accounts)',
                            'manual' => 'Manual Mode (Admin manually reviews and transfers payouts)'
                        ], setting('vendor_payout_mode', 'stripe_connect'), ['class' => 'select2 form-control']) !!}
                        <div class="form-text text-muted mt-2">
                            Switch between <strong>Stripe Connect</strong> (vendors link their UK bank account and receive automated transfers) and <strong>Manual Mode</strong> (admin reviews withdrawal requests and transfers funds manually).
                        </div>
                    </div>
                </div>
