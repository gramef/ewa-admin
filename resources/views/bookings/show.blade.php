                ...
                <div class="card-body p-0">
                    ...
                    <div class="d-flex flex-column flex-md-row">
                        ...
                        <ul class="list-group list-group-flush col-12 col-lg-5 p-0">
                            ...
                            <li class="list-group-item bg-light">
                                <b>VAT</b>
                                @if($booking->isProviderBelowVatThreshold())
                                    <small class="text-muted ml-2">(Exempt — provider below £50k threshold)</small>
                                @endif
                            </li>
                            @foreach($booking->taxes as $tax)
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <span><b>{{ preg_replace('/\btax\b/i', 'VAT', $tax->name) }}</b></span>
