...
class NewEProviderPayout extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject(trans('lang.notification_new_e_provider_payout', ['e_provider_payout_id' => $this->eProviderPayout->id, 'user_name' => $this->eProvider->name]) . " | " . setting('app_name', ''))
            ->greeting(trans('lang.notification_new_e_provider_payout', ['e_provider_payout_id' => $this->eProviderPayout->id, 'user_name' => $this->eProvider->name]))
    ...
    public function toFcm($notifiable): FcmMessage
    {
        ...
        $notification = [
            ...
            'body' => trans('lang.notification_new_e_provider_payout', ['e_provider_payout_id' => $this->eProviderPayout->id, 'user_name' => $this->eProvider->name]),
            'icon' => $this->getEServiceMediaUrl(),
            'click_action' => "FLUTTER_NOTIFICATION_CLICK",
            'id' => 'App\Notifications\NewEProviderPayout',
            'status' => 'done',
        ];
        $data = $notification;
