...
class EProvider extends Model implements HasMedia, Castable
{
    ...
    /**
     * Get the primary owner (first user linked to this provider).
     * Used by admin views like KYC review.
     */
    public function user()
    {
        return $this->belongsToMany(User::class, 'e_provider_users')->limit(1);
    }
