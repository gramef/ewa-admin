...
class Booking extends Model
{
    ...
    /**
     * Safety relationship method for eService eager loading.
     * e_service is stored as a JSON cast attribute on the model, so this prevents 500 errors when with=eService is requested in API calls.
     */
    public function eService()
    {
        return $this->belongsTo(EService::class, 'id', 'id')->whereRaw('1=0');
    }
