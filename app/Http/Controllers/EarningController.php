...
class EarningController extends Controller
{
    ...
    public function __construct(EarningRepository $earningRepo, CustomFieldRepository $customFieldRepo, EProviderRepository $eProviderRepo, BookingRepository $bookingRepository, EProviderPayoutRepository $eProviderPayoutRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        foreach ($eProviders as $eProvider) {
            try {
                // Skip providers without a type (commission cannot be calculated)
                if (empty($eProvider->eProviderType)) {
                    continue;
                }
